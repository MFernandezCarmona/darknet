...
# Private? methods
    ...
    def detect2(self,net, meta, im, thresh=.5, hier_thresh=.5, nms=.45):
        ...
        'cake':['scrubby'],
        'bottle':['noodles','coke','sprite','sausages','pringles','chocolate drink'],
        'book':['crackers','chips'],
                ...
                if dets[j].prob[i] > 0:
                    ...
                    if darknetName in darknet2Montreal.keys():
                        for montrealName in darknet2Montreal[darknetName]:
                            res.append((montrealName, dets[j].prob[i], (b.x, b.y, b.w, b.h)))
                    else:
                        res.append((darknetName, dets[j].prob[i], (b.x, b.y, b.w, b.h))) 
