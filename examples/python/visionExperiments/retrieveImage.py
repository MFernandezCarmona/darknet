...
def main(session, robot_ip, port,camera):
    """
...
class ImageWidget(QWidget):
    ...
    def _registerImageClient(self):
        ...
        self._imgClient = self.video_service.subscribe("_client2", resolution, colorSpace, 5)
...
if __name__ == "__main__":
    ...
    try:
        ...
        sys.exit(1)
    main(session, args.ip, args.port,args.camera)